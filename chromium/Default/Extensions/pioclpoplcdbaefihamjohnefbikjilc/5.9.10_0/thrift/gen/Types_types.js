...
NoteAttributes = function(args) {
  ...
  if (args) {
    ...
    if (args.taskCompleteDate !== undefined) {
      this.taskCompleteDate = args.taskCompleteDate;
    }
    if (args.taskDueDate !== undefined) {
      this.taskDueDate = args.taskDueDate;
    }
...
NoteAttributes.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 19:
      if (ftype == Thrift.Type.I64) {
        this.taskCompleteDate = input.readI64();
      } else {
        input.skip(ftype);
      }
      break;
      case 20:
      if (ftype == Thrift.Type.I64) {
        this.taskDueDate = input.readI64();
      } else {
        input.skip(ftype);
      }
      break;
...
NoteAttributes.prototype.write = function(output) {
  ...
  if (this.taskDate !== null && this.taskDate !== undefined) {
    output.writeFieldBegin('taskDate', Thrift.Type.I64, 18);
    output.writeI64(this.taskDate);
    output.writeFieldEnd();
  }
  if (this.taskCompleteDate !== null && this.taskCompleteDate !== undefined) {
    output.writeFieldBegin('taskCompleteDate', Thrift.Type.I64, 19);
    output.writeI64(this.taskCompleteDate);
    output.writeFieldEnd();
  }
  if (this.taskDueDate !== null && this.taskDueDate !== undefined) {
    output.writeFieldBegin('taskDueDate', Thrift.Type.I64, 20);
    output.writeI64(this.taskDueDate);
    output.writeFieldEnd();
  }
