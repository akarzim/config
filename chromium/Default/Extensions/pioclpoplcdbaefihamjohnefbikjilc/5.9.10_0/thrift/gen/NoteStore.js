...
NoteStore_expungeNotes_args.prototype.write = function(output) {
  ...
  if (this.noteGuids !== null && this.noteGuids !== undefined) {
    ...
    for (var iter285 in this.noteGuids)
    {
      if (this.noteGuids.hasOwnProperty(iter285))
      {
        iter285 = this.noteGuids[iter285];
...
NoteStore_sendMessageToSharedNotebookMembers_args.prototype.write = function(output) {
  ...
  if (this.recipients !== null && this.recipients !== undefined) {
    ...
    for (var iter309 in this.recipients)
    {
      if (this.recipients.hasOwnProperty(iter309))
      {
        iter309 = this.recipients[iter309];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem324 = null;
          elem324 = input.readI64();
          this.sharedNotebookIds.push(elem324);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
NoteStore_expungeSharedNotebooks_args.prototype.write = function(output) {
  ...
  if (this.sharedNotebookIds !== null && this.sharedNotebookIds !== undefined) {
    ...
    for (var iter325 in this.sharedNotebookIds)
    {
      if (this.sharedNotebookIds.hasOwnProperty(iter325))
      {
        iter325 = this.sharedNotebookIds[iter325];
        output.writeI64(iter325);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
...
var me = this;
try {
  this.send_getSyncState(authenticationToken, function() { callback.onSuccess(me.recv_getSyncState()); });
} catch(e) {
...
var me = this;
try {
this.send_getSyncStateWithMetrics(authenticationToken, clientMetrics, function() { callback.onSuccess(me.recv_getSyncStateWithMetrics()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getSyncChunk(authenticationToken, afterUSN, maxEntries, fullSyncOnly, function() { callback.onSuccess(me.recv_getSyncChunk()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getFilteredSyncChunk(authenticationToken, afterUSN, maxEntries, filter, function() { callback.onSuccess(me.recv_getFilteredSyncChunk()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getLinkedNotebookSyncState(authenticationToken, linkedNotebook, function() { callback.onSuccess(me.recv_getLinkedNotebookSyncState()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getLinkedNotebookSyncChunk(authenticationToken, linkedNotebook, afterUSN, maxEntries, fullSyncOnly, function() { callback.onSuccess(me.recv_getLinkedNotebookSyncChunk()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_listNotebooks(authenticationToken, function() { callback.onSuccess(me.recv_listNotebooks()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getNotebook(authenticationToken, guid, function() { callback.onSuccess(me.recv_getNotebook()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getDefaultNotebook(authenticationToken, function() { callback.onSuccess(me.recv_getDefaultNotebook()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_createNotebook(authenticationToken, notebook, function() { callback.onSuccess(me.recv_createNotebook()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_updateNotebook(authenticationToken, notebook, function() { callback.onSuccess(me.recv_updateNotebook()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_expungeNotebook(authenticationToken, guid, function() { callback.onSuccess(me.recv_expungeNotebook()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_listTags(authenticationToken, function() { callback.onSuccess(me.recv_listTags()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_listTagsByNotebook(authenticationToken, notebookGuid, function() { callback.onSuccess(me.recv_listTagsByNotebook()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getTag(authenticationToken, guid, function() { callback.onSuccess(me.recv_getTag()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_createTag(authenticationToken, tag, function() { callback.onSuccess(me.recv_createTag()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_updateTag(authenticationToken, tag, function() { callback.onSuccess(me.recv_updateTag()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_untagAll(authenticationToken, guid, function() { callback.onSuccess(me.recv_untagAll()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_expungeTag(authenticationToken, guid, function() { callback.onSuccess(me.recv_expungeTag()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_listSearches(authenticationToken, function() { callback.onSuccess(me.recv_listSearches()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getSearch(authenticationToken, guid, function() { callback.onSuccess(me.recv_getSearch()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_createSearch(authenticationToken, search, function() { callback.onSuccess(me.recv_createSearch()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_updateSearch(authenticationToken, search, function() { callback.onSuccess(me.recv_updateSearch()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_expungeSearch(authenticationToken, guid, function() { callback.onSuccess(me.recv_expungeSearch()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_findNotes(authenticationToken, filter, offset, maxNotes, function() { callback.onSuccess(me.recv_findNotes()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_findNoteOffset(authenticationToken, filter, guid, function() { callback.onSuccess(me.recv_findNoteOffset()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_findNotesMetadata(authenticationToken, filter, offset, maxNotes, resultSpec, function() { callback.onSuccess(me.recv_findNotesMetadata()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_findNoteCounts(authenticationToken, filter, withTrash, function() { callback.onSuccess(me.recv_findNoteCounts()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getNote(authenticationToken, guid, withContent, withResourcesData, withResourcesRecognition, withResourcesAlternateData, function() { callback.onSuccess(me.recv_getNote()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getNoteApplicationData(authenticationToken, guid, function() { callback.onSuccess(me.recv_getNoteApplicationData()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getNoteApplicationDataEntry(authenticationToken, guid, key, function() { callback.onSuccess(me.recv_getNoteApplicationDataEntry()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_setNoteApplicationDataEntry(authenticationToken, guid, key, value, function() { callback.onSuccess(me.recv_setNoteApplicationDataEntry()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_unsetNoteApplicationDataEntry(authenticationToken, guid, key, function() { callback.onSuccess(me.recv_unsetNoteApplicationDataEntry()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getNoteContent(authenticationToken, guid, function() { callback.onSuccess(me.recv_getNoteContent()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getNoteSearchText(authenticationToken, guid, noteOnly, tokenizeForIndexing, function() { callback.onSuccess(me.recv_getNoteSearchText()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getResourceSearchText(authenticationToken, guid, function() { callback.onSuccess(me.recv_getResourceSearchText()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getNoteTagNames(authenticationToken, guid, function() { callback.onSuccess(me.recv_getNoteTagNames()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
this.send_createNote(authenticationToken, note, function() {
  try {
    callback.onSuccess(me.recv_createNote());
  } catch(e) {
    callback.onFailure(e);
  }
});
...
var me = this;
try {
this.send_updateNote(authenticationToken, note, function() { callback.onSuccess(me.recv_updateNote()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_deleteNote(authenticationToken, guid, function() { callback.onSuccess(me.recv_deleteNote()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_expungeNote(authenticationToken, guid, function() { callback.onSuccess(me.recv_expungeNote()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_expungeNotes(authenticationToken, noteGuids, function() { callback.onSuccess(me.recv_expungeNotes()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_expungeInactiveNotes(authenticationToken, function() { callback.onSuccess(me.recv_expungeInactiveNotes()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_copyNote(authenticationToken, noteGuid, toNotebookGuid, function() { callback.onSuccess(me.recv_copyNote()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_listNoteVersions(authenticationToken, noteGuid, function() { callback.onSuccess(me.recv_listNoteVersions()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getNoteVersion(authenticationToken, noteGuid, updateSequenceNum, withResourcesData, withResourcesRecognition, withResourcesAlternateData, function() { callback.onSuccess(me.recv_getNoteVersion()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getResource(authenticationToken, guid, withData, withRecognition, withAttributes, withAlternateData, function() { callback.onSuccess(me.recv_getResource()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getResourceApplicationData(authenticationToken, guid, function() { callback.onSuccess(me.recv_getResourceApplicationData()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getResourceApplicationDataEntry(authenticationToken, guid, key, function() { callback.onSuccess(me.recv_getResourceApplicationDataEntry()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_setResourceApplicationDataEntry(authenticationToken, guid, key, value, function() { callback.onSuccess(me.recv_setResourceApplicationDataEntry()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_unsetResourceApplicationDataEntry(authenticationToken, guid, key, function() { callback.onSuccess(me.recv_unsetResourceApplicationDataEntry()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_updateResource(authenticationToken, resource, function() { callback.onSuccess(me.recv_updateResource()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getResourceData(authenticationToken, guid, function() { callback.onSuccess(me.recv_getResourceData()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getResourceByHash(authenticationToken, noteGuid, contentHash, withData, withRecognition, withAlternateData, function() { callback.onSuccess(me.recv_getResourceByHash()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getResourceRecognition(authenticationToken, guid, function() { callback.onSuccess(me.recv_getResourceRecognition()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getResourceAlternateData(authenticationToken, guid, function() { callback.onSuccess(me.recv_getResourceAlternateData()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getResourceAttributes(authenticationToken, guid, function() { callback.onSuccess(me.recv_getResourceAttributes()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getAds(authenticationToken, adParameters, function() { callback.onSuccess(me.recv_getAds()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getRandomAd(authenticationToken, adParameters, function() { callback.onSuccess(me.recv_getRandomAd()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getPublicNotebook(userId, publicUri, function() { callback.onSuccess(me.recv_getPublicNotebook()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_createSharedNotebook(authenticationToken, sharedNotebook, function() { callback.onSuccess(me.recv_createSharedNotebook()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_updateSharedNotebook(authenticationToken, sharedNotebook, function() { callback.onSuccess(me.recv_updateSharedNotebook()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_sendMessageToSharedNotebookMembers(authenticationToken, notebookGuid, messageText, recipients, function() { callback.onSuccess(me.recv_sendMessageToSharedNotebookMembers()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_listSharedNotebooks(authenticationToken, function() { callback.onSuccess(me.recv_listSharedNotebooks()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_expungeSharedNotebooks(authenticationToken, sharedNotebookIds, function() { callback.onSuccess(me.recv_expungeSharedNotebooks()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_createLinkedNotebook(authenticationToken, linkedNotebook, function() { callback.onSuccess(me.recv_createLinkedNotebook()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_updateLinkedNotebook(authenticationToken, linkedNotebook, function() { callback.onSuccess(me.recv_updateLinkedNotebook()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_listLinkedNotebooks(authenticationToken, function() { callback.onSuccess(me.recv_listLinkedNotebooks()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_expungeLinkedNotebook(authenticationToken, guid, function() { callback.onSuccess(me.recv_expungeLinkedNotebook()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_authenticateToSharedNotebook(shareKey, authenticationToken, function() { callback.onSuccess(me.recv_authenticateToSharedNotebook()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_getSharedNotebookByAuth(authenticationToken, function() { callback.onSuccess(me.recv_getSharedNotebookByAuth()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_emailNote(authenticationToken, parameters, function() { callback.onSuccess(me.recv_emailNote()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_shareNote(authenticationToken, guid, function() { callback.onSuccess(me.recv_shareNote()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_stopSharingNote(authenticationToken, guid, function() { callback.onSuccess(me.recv_stopSharingNote()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_authenticateToSharedNote(guid, noteKey, function() { callback.onSuccess(me.recv_authenticateToSharedNote()); });
} catch(e) {
callback.onFailure(e);
}
};
...
var me = this;
try {
this.send_findRelated(authenticationToken, query, resultSpec, function() { callback.onSuccess(me.recv_findRelated()); });
} catch(e) {
callback.onFailure(e);
}
};
