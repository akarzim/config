...
Thrift.TBinaryProtocol = function(aTransport, aStrictRead, aStrictWrite) {
  ...
  var _utf8Encode = function(str) {
    ...
    for (var i = 0; i < str.length; i++) {
      ...
      if (code < 128) {
        ...
        utf8str += String.fromCharCode((code >> 6) | 192);
        utf8str += String.fromCharCode((code & 63) | 128);
      }
      else {
        utf8str += String.fromCharCode((code >> 12) | 224);
        utf8str += String.fromCharCode(((code >> 6) & 63) | 128);
        utf8str += String.fromCharCode((code & 63) | 128);
      }
    }
    return utf8str;
  ...
  var _utf8Decode = function(utf8str) {
    ...
    for ( var i = 0; i < utf8str.length;) {
      ...
      if (code < 128)
        ...
        str[j++] = String.fromCharCode(((code - 192) << 6) + (code2 - 128));
      else if (code < 240)
        str[j++] = String.fromCharCode(((code - 224) << 12) + ((code2 - 128) << 6)
            + (code3 - 128));
      else
        str[j++] = String.fromCharCode(((code - 240) << 18) + ((code2 - 128) << 12)
  ...
  this.skip = function(type) {
    ...
    case Thrift.Type.STRUCT:
      ...
      while (true) {
        var result = protocol.readFieldBegin();
  ...
  this.writeBinary = function(value) {
    ...
    transport.writeData(value, 0, length);
  };
